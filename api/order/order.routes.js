...
const { getOrders, addOrder, deleteOrder, updateOrder, addOrderMsg, removeOrderMsg, updateOrders } = require('./order.controller')
...
router.put('/', log, requireAuth, updateOrders)
